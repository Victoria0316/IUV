...
public class RecommendCountyResponse extends IuwHttpResponse {
    ...
    public ArrayList<RecommendCountyInfo> data = new ArrayList<RecommendCountyInfo>();
    ...
    public static class RecommendCountyInfo {
        ...
        public String issuanceNum;//发行数量;
        public String surplusNum;//剩余数量;
        public String userNum;//使用总数;
        public String imgPath;//图片路径;
        public String shopAddress;//商场详细地址；
