 ...
 */
public class PersonalCenterMyCollectMarketAdapter extends BaseAdapter {
    protected final static String tag ="PersonalCenterMyCollectMarketAdapter";
    ...
    public PersonalCenterMyCollectMarketAdapter(Context context, List<PersonalCenterMyInformBean> data) {
        this.mListData=data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_my_collect_market,
                    null);
