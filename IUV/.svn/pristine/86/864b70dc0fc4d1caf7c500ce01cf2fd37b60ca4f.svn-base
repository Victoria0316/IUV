...
import bluemobi.iuv.network.request.HotShop3rdListRequest;
...
public class SpecialtyStoreFragment extends BaseFragment {
                        ...
                        public void convert(final ViewHolder helper, HotShopInfo bean) {
                            ...
                            iv_treasure_icon.setOnClickListener(new View.OnClickListener() {
                                                                    ...
                                                                    public void onClick(View v) {
                                                                        ...
                                                                        Utils.moveToFragment(TreasureDetailFragment.class, SpecialtyStoreFragment.this, "treasureDetailFragment");
                            ...
                            iv_goods_icon.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ((MainActivity) mContext).isHiddChange = false;
                                    Utils.moveToFragment(MarketInfoFragment.class, SpecialtyStoreFragment.this, "MarketInfoFragment");
    ...
    {
        HotShop3rdListRequest request = new HotShop3rdListRequest(
        ...
        if ("2".equals(divisionType)) {
            ...
            request.setShopDistrictCod(divisionCode == null ? "" : divisionCode);
        }
