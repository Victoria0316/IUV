...
public class GuideActivity extends Activity implements GestureDetector.OnGestureListener {
    ...
    private void initGuidePage() {
        ...
        ImageView guideImg4 = new ImageView(this);
        guideImg4.setBackgroundResource(R.drawable.guide4);
        guideImg4.setTag("end");

        FrameLayout frameLayout = new FrameLayout(this);
        frameLayout.addView(guideImg4, FrameLayout.LayoutParams.MATCH_PARENT,
                FrameLayout.LayoutParams.MATCH_PARENT);

        ImageView startImage = new ImageView(this);
        startImage.setBackgroundResource(R.drawable.click_from_here);
        ...
        mGuideFlipper.addView(guideImg3, 2);
        mGuideFlipper.addView(frameLayout, 3);
