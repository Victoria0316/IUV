...
public class LargeDepartmentStoresPage extends BasePage {
    ...
    public void transData() {
        ...
        if (isDetailFragment) {
            ...
            this.mID= fragment.mID;
            Logger.e("transData--mID->",mID);
            Logger.e("tag-----mDivisionType--->",mDivisionType);
        } else {
...

                                                            {
                                                                ...
                                                                public void onClick(View v) {
                                                                    ...
                                                                    if (isDetailFragment) {
                                                                        ...
                                                                        Utils.moveToFragment(TreasureDetailFragment.class, mHomeTreasureFragment, "treasureDetailFragment");
                                                                    }
                        ...
                        iv_goods_icon.setOnClickListener(new View.OnClickListener(
...

                                                         {
                                                             ...
                                                             public void onClick(View v) {
                                                                 ...
                                                                 storeDetailsEvent.setMarketType(Constants.LARGE_MARKET);
    ...
    private IuwHttpJsonRequest commonRequest(int startPage)
    {
        ...
        Logger.e("TAG--mDivisionType-->",mDivisionType);
        if ("1".equals(mDivisionType)) // divisionType:区划类型：0国家1省份2地市3区县
        {
        ...
        {
            request.setShopDistrictCode(mID==null?"":mID); //区
        }
