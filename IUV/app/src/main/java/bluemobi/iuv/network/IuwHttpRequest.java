...
public abstract class IuwHttpRequest<T extends IuwHttpResponse> extends
        Request<T> implements IuwHttpBase<T>
{
     ...
     * @param errorListener
     */
    public IuwHttpRequest(int method, String partUrl, Listener<T> listener,
    ...
    public IuwHttpRequest(int method, String serverUrl, String partUrl, Listener<T> listener,
                          ErrorListener errorListener)
    {
