 ...
 *
 */
public class CollectGoodRequest extends
        IuwHttpJsonRequest<GivePraiseResponse>
{

    private static final String APIPATH = "mobi/productinfo/collectProduct";

    private String id;//商场ID
    private String userId;//用户ID

    public CollectGoodRequest(Response.Listener<GivePraiseResponse> listener,
                              Response.ErrorListener errorListener)
    {
        super(Method.POST, APIPATH, listener, errorListener);
    }

    public CollectGoodRequest(int method, String partUrl,
