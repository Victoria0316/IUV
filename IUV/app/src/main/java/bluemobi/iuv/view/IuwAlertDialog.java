...
public final class IuwAlertDialog {
	...
	public IuwAlertDialog(Context context) {
	...
	public IuwAlertDialog addView(View v) {
	...
	public IuwAlertDialog setTitle(String text) {
		if (titleView == null) {
	...
	public IuwAlertDialog setMessage(String message) {
	...
	public IuwAlertDialog setNegativeButtonClickListener(String text,
	...
	public IuwAlertDialog setPositiveButtonClickListener(String text,
			OnClickListener listener) {
	...
	public IuwAlertDialog setPositiveButtonText(String text) {
		if (leftButton == null) {
	...
	public IuwAlertDialog setNegativeButtonText(String text) {
		if (rightButton == null) {
...
//		dividerParam.setMargins(dp10, 0, dp10, 0);
	...
	private void layout() {
		...
		if (titleView != null) {
			...
			RelativeLayout.LayoutParams upperParam = (RelativeLayout.LayoutParams) upperDivider
					.getLayoutParams();
		...
		if (!isContentLayoutEmpty()) {
			...
			RelativeLayout.LayoutParams lowerParam = (RelativeLayout.LayoutParams) lowerDivider
					.getLayoutParams();
